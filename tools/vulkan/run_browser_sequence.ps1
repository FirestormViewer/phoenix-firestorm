...
try {
    if ($ControlledReplay) {
        ...
        $effects=@(
            ...
            @{age=2800000;state='tooltip-enter';action={ Move-SequencePointer 1100 446 }},
            @{age=3400000;state='tooltip-delay';action={}},
            @{age=3600000;state='tooltip-visible';action={}},
            @{age=3650000;state='tooltip-scrub-enter';action={ Move-SequencePointer 1595 445 }},
            @{age=3850000;state='tooltip-scrub-visible';action={}},
            @{age=3900000;state='tooltip-depart';action={ Move-SequencePointer 2200 900 }},
            @{age=4950000;state='tooltip-far-timeout';action={}},
            @{age=5050000;state='tooltip-far-fade';action={}},
            @{age=5250000;state='tooltip-far-expired';action={}},
            @{age=5300000;state='tooltip-return';action={ Move-SequencePointer 1100 446 }},
            @{age=6100000;state='tooltip-return-visible';action={}},
            @{age=6200000;state='tooltip-window-leave';action={ Send-SequenceMessage 0x2A3 0 0 }},
            @{age=6300000;state='tooltip-leave-fade';action={}},
            @{age=6450000;state='tooltip-leave-expired';action={}},
            @{age=6500000;state='tooltip-window-reenter';action={ Move-SequencePointer 2200 900 }},
            @{age=6550000;state='tooltip-focus-enter';action={ Move-SequencePointer 1100 446 }},
            @{age=7400000;state='tooltip-focus-visible';action={}},
            @{age=7500000;state='tooltip-focus-lost';action={ Send-SequenceMessage 0x8 0 0 }},
            @{age=7600000;state='tooltip-focus-fade';action={}},
            @{age=7750000;state='tooltip-focus-expired';action={}},
            @{age=7800000;state='tooltip-focus-regained';action={ Send-SequenceMessage 0x7 0 0; Move-SequencePointer 2200 900 }},
            @{age=7850000;state='tooltip-near-enter';action={ Move-SequencePointer 1100 446 }},
            @{age=8700000;state='tooltip-near-visible';action={}},
            @{age=18500000;state='tooltip-near-before-timeout';action={}},
            @{age=18800000;state='tooltip-near-timeout';action={}},
            @{age=18900000;state='tooltip-near-next-frame';action={}},
            @{age=19000000;state='tooltip-edge-drag-pressed';action={ Move-SequencePointer 1000 422; Send-SequenceMessage 0x201 1 ((422 -shl 16) -bor 1000) }},
            @{age=19100000;state='tooltip-edge-drag-moved';action={ Move-SequencePointer 1900 800 }},
            @{age=19200000;state='tooltip-edge-drag-released';action={ Send-SequenceMessage 0x202 0 ((800 -shl 16) -bor 1900) }},
            @{age=19300000;state='tooltip-edge-enter';action={ Move-SequencePointer 2495 823 }},
            @{age=20100000;state='tooltip-edge-visible';action={}},
            @{age=20200000;state='tooltip-edge-key';action={ Send-SequenceKey 0x23 }},
            @{age=20300000;state='tooltip-edge-fade';action={}},
            @{age=20500000;state='tooltip-edge-expired';action={}},
            @{age=20600000;state='tooltip-bottom-drag-pressed';action={ Move-SequencePointer 1900 800; Send-SequenceMessage 0x201 1 ((800 -shl 16) -bor 1900) }},
            @{age=20700000;state='tooltip-bottom-drag-moved';action={ Move-SequencePointer 1900 1240 }},
            @{age=20800000;state='tooltip-bottom-drag-released';action={ Send-SequenceMessage 0x202 0 ((1240 -shl 16) -bor 1900) }},
            @{age=20900000;state='tooltip-bottom-enter';action={ Move-SequencePointer 2000 1264 }},
            @{age=21800000;state='tooltip-bottom-visible';action={}},
            @{age=21900000;state='tooltip-bottom-key';action={ Send-SequenceKey 0x23 }},
            @{age=22000000;state='tooltip-bottom-fade';action={}},
            @{age=22200000;state='tooltip-bottom-expired';action={}}
        )
