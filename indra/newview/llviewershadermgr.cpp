...
BOOL LLViewerShaderMgr::loadShadersDeferred()
{
	...
	if (success)
	{
		...
		gDeferredTreeShadowProgram.addPermutation("DEPTH_CLAMP", /*gGLManager.mHasDepthClamp ? "1" :*/ "0"); // <FS> Fix void and region water flickr by Drake Arconis (Alchemy viewer)
	...
	if (success)
	{
		...
		gDeferredShadowProgram.addPermutation("DEPTH_CLAMP", /*gGLManager.mHasDepthClamp ? "1" :*/ "0"); // <FS> Fix void and region water flickr by Drake Arconis (Alchemy viewer)
	...
	if (success)
	{
		...
		gDeferredShadowCubeProgram.addPermutation("DEPTH_CLAMP", /*gGLManager.mHasDepthClamp ? "1" :*/ "0"); // <FS> Fix void and region water flickr by Drake Arconis (Alchemy viewer)
	...
	if (success)
	{
		...
		gDeferredShadowAlphaMaskProgram.addPermutation("DEPTH_CLAMP", /*gGLManager.mHasDepthClamp ? "1" :*/ "0"); // <FS> Fix void and region water flickr by Drake Arconis (Alchemy viewer)
	...
	if (success)
	{
		...
		gDeferredAvatarShadowProgram.addPermutation("DEPTH_CLAMP", /*gGLManager.mHasDepthClamp ? "1" :*/ "0"); // <FS> Fix void and region water flickr by Drake Arconis (Alchemy viewer)
	...
	if (success)
	{
		...
		gDeferredAttachmentShadowProgram.addPermutation("DEPTH_CLAMP", /*gGLManager.mHasDepthClamp ? "1" :*/ "0"); // <FS> Fix void and region water flickr by Drake Arconis (Alchemy viewer)
