	...
	mInventoryViewModel(p.name)
{
	...
	mCommitCallbackRegistrar.add("Inventory.Purge", boost::bind(&do_nothing)); // <FS:Ansariel> Prevent warning "No callback found for: 'Inventory.Purge' in control: Purge Item"
}
