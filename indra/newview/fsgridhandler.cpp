...
void gridDownloadComplete( LLSD const &aData, LLGridManager* mOwner, GridEntry* mData, LLGridManager::AddState mState )
{
    ...
    else if (HTTP_OK ==  status.getType() )// OK
    {
        ...
        if(LLXMLNode::parseBuffer( reinterpret_cast<char*> ( &stringData[0] ), (U64)stringData.size(), mData->info_root, NULL))
        {
...
const char* DEFAULT_LOGIN_PAGE = "https://storm.ayane.li/";
