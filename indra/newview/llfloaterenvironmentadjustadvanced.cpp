/**
 * @file llfloaterfixedenvironmentadvanced.cpp
...
//=========================================================================
LLFloaterEnvironmentAdjustAdvanced::LLFloaterEnvironmentAdjustAdvanced(const LLSD &key):
    LLFloater(key)
{}

LLFloaterEnvironmentAdjustAdvanced::~LLFloaterEnvironmentAdjustAdvanced()
{}

//-------------------------------------------------------------------------
bool LLFloaterEnvironmentAdjustAdvanced::postBuild()
{
...
void LLFloaterEnvironmentAdjustAdvanced::onOpen(const LLSD& key)
{
    if (!mLiveSky)
    {
...
void LLFloaterEnvironmentAdjustAdvanced::onClose(bool app_quitting)
{
...
//-------------------------------------------------------------------------
void LLFloaterEnvironmentAdjustAdvanced::refresh()
{
...
void LLFloaterEnvironmentAdjustAdvanced::captureCurrentEnvironment()
{
...
void LLFloaterEnvironmentAdjustAdvanced::onButtonReset()
{
...
//-------------------------------------------------------------------------
void LLFloaterEnvironmentAdjustAdvanced::onAmbientLightChanged()
{
    if (!mLiveSky)
        return;
...
void LLFloaterEnvironmentAdjustAdvanced::onBlueHorizonChanged()
{
    if (!mLiveSky)
        return;
...
void LLFloaterEnvironmentAdjustAdvanced::onBlueDensityChanged()
{
    if (!mLiveSky)
        return;
...
void LLFloaterEnvironmentAdjustAdvanced::onHazeHorizonChanged()
{
    if (!mLiveSky)
        return;
...
void LLFloaterEnvironmentAdjustAdvanced::onHazeDensityChanged()
{
    if (!mLiveSky)
        return;
...
void LLFloaterEnvironmentAdjustAdvanced::onSceneGammaChanged()
{
    if (!mLiveSky)
        return;
...
void LLFloaterEnvironmentAdjustAdvanced::onCloudColorChanged()
{
    if (!mLiveSky)
        return;
...
void LLFloaterEnvironmentAdjustAdvanced::onCloudCoverageChanged()
{
    if (!mLiveSky)
        return;
...
void LLFloaterEnvironmentAdjustAdvanced::onCloudScaleChanged()
{
    if (!mLiveSky)
        return;
...
void LLFloaterEnvironmentAdjustAdvanced::onGlowChanged()
{
    if (!mLiveSky)
        return;
...
void LLFloaterEnvironmentAdjustAdvanced::onStarBrightnessChanged()
{
    if (!mLiveSky)
        return;
...
void LLFloaterEnvironmentAdjustAdvanced::onSunRotationChanged()
{
...
void LLFloaterEnvironmentAdjustAdvanced::onSunAzimElevChanged()
{
...
void LLFloaterEnvironmentAdjustAdvanced::onSunScaleChanged()
{
    if (!mLiveSky)
        return;
...
void LLFloaterEnvironmentAdjustAdvanced::onMoonRotationChanged()
{
...
void LLFloaterEnvironmentAdjustAdvanced::onMoonAzimElevChanged()
{
...
void LLFloaterEnvironmentAdjustAdvanced::onCloudMapChanged()
{
    if (!mLiveSky)
        return;
...
void LLFloaterEnvironmentAdjustAdvanced::onWaterMapChanged()
{
    if (!mLiveWater)
        return;
...
void LLFloaterEnvironmentAdjustAdvanced::onSunColorChanged()
{
    if (!mLiveSky)
        return;
...
void LLFloaterEnvironmentAdjustAdvanced::onReflectionProbeAmbianceChanged()
{
    if (!mLiveSky) return;
...
void LLFloaterEnvironmentAdjustAdvanced::updateGammaLabel()
{
    if (!mLiveSky) return;
...
void LLFloaterEnvironmentAdjustAdvanced::onEnvironmentUpdated(LLEnvironment::EnvSelection_t env, S32 version)
{
