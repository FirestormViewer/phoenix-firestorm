...
class BDFloaterPoser : public LLFloater
{
  ...
  private:
    ...
    bool havePermissionToAnimateAvatar(LLVOAvatar *avatar);  //<FS>[FIRE - 30873] : Poser future: Use LSL bridge to ask permission to animate other avatar
