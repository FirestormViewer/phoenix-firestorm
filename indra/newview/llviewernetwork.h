...
class LLGridManager : public LLSingleton<LLGridManager>
{
  ...
  public:
    ...
    std::string getGrid( const std::string &grid ) const; // <FS:Beq/> const correctness needed for Linux and MacOS
    ...
    std::string getGrid() const { return mGrid; }; // <FS:Beq/> const correctness needed for Linux and MacOS
