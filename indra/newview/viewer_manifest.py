...
class WindowsManifest(ViewerManifest):
    ...
    def package_finish(self):
        ...
        try:
            subprocess.check_call(["signtool.exe","sign","/a","/d","Firestorm","/du","http://www.phoenixviewer.com",self.args['configuration']+"\\firestorm-bin.exe"],stderr=PIPE,stdout=PIPE)
            subprocess.check_call(["signtool.exe","sign","/a","/d","Firestorm","/du","http://www.phoenixviewer.com",self.args['configuration']+"\\"+self.final_exe()],stderr=PIPE,stdout=PIPE)
        except Exception, e:
        ...
        try:
            subprocess.check_call(["signtool.exe","sign","/a","/d","Firestorm","/du","http://www.phoenixviewer.com",self.args['configuration']+"\\"+substitution_strings['installer_file']],stderr=PIPE,stdout=PIPE)
        except Exception, e:
