...
void send_agent_update(bool force_send, bool send_reliable)
{
    ...
    constexpr F64 MAX_AGENT_UPDATES_PER_SECOND = 25.0; // Value derived experimentally to avoid Input Delays with latest PBR-Capable Viewers when viewer FPS is highly volatile.
