/**
 * @file llfloaterenvironmentadjustadvancedadvanced.h
...
#ifndef LL_FLOATERENVIRONMENTADJUSTADVANCED_H
#define LL_FLOATERENVIRONMENTADJUSTADVANCED_H
 ...
 */
class LLFloaterEnvironmentAdjustAdvanced : public LLFloater
{
    LOG_CLASS(LLFloaterEnvironmentAdjustAdvanced);

public:
                                LLFloaterEnvironmentAdjustAdvanced(const LLSD &key);
    virtual                     ~LLFloaterEnvironmentAdjustAdvanced();
...
#endif // LL_FLOATERENVIRONMENTADJUSTADVANCED_H
