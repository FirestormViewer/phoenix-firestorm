	  ...
	  mNeedUploadCost(true)
{
	...
	mCommitCallbackRegistrar.add("Inventory.DoCreate", boost::bind(&LLPanelMainInventory::doCreate, this, _2));
 	mCommitCallbackRegistrar.add("Inventory.NewWindow", boost::bind(&LLPanelMainInventory::newWindow, this)); // <FS:Ansariel> Re-enabled; Callback handler in LLViewerMenu is routing to unused (and dangerous) legacy code!
