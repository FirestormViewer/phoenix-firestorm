...
//    LLFloaterReg::add("floater_settings_picker", "floater_settings_picker.xml" , (LLFloaterBuildFunc)&LLFloaterReg::build<LLFloaterItemProperties>);
	...
	LLFloaterReg::add("performance", "floater_performance_fs.xml", (LLFloaterBuildFunc)&LLFloaterReg::build<FSFloaterPerformance>);
...
// [/RLVa:KB]
	...
	// LLFloaterReg::add("performance", "floater_performance.xml", (LLFloaterBuildFunc)&LLFloaterReg::build<LLFloaterPerformance>); // <FS:Beq/> restore perf floater
	LLFloaterReg::add("performance", "floater_performance_fs.xml", (LLFloaterBuildFunc)&LLFloaterReg::build<FSFloaterPerformance>);
